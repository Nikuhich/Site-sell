...
const btn_table_second = document.querySelector('.header__btn')
const btn_table_last = document.querySelector('.contact__link-block-reserve-box-btn')
...
btn_table_second.addEventListener('click', function () {
    block_table.classList.add('active-table')
    block_table.classList.remove('possive-table')
})

btn_table_last.addEventListener('click', function () {
    block_table.classList.add('active-table')
    block_table.classList.remove('possive-table')
})
